...
const (
	greetingMsg = "Привет! Я Юрий Ткаченко. Теперь я буду следить за нравственным порядком и ущемлением прав LGBTQIA здесь и по-хорошему просить удалить нахуй этот позор. DID YOU JUST ASSUME MY GENDER?!"
